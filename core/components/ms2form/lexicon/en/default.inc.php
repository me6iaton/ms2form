...
$_lang['ms2form_err_no_auth'] = 'You need to login to create a resource.';
$_lang['ms2form_err_publish'] = 'You are not allowed to publish this resources.';
$_lang['ms2form_err_empty'] = 'You forgot to write the text of the resource.';
